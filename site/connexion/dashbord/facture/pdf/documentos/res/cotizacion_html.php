...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
		...
		<td style="width:50%; ">
		    ...
		    <br>Lieux :
		    <br> Téléphone:</td>
		<!-- php qui recup données du connecter -->
		</tr>
	</table>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
        <tr>
            ...
            <td style="width:50%; ">Nom et Prénom:</td>
            <td style="width:50%"><?php echo $atencion; ?> </td>
			<td style="width:50%;text-align:right"> Teléphone:</td>
			<td style="width:50%">&nbsp;<?php echo $tel1; ?> </td>
        </tr>
        <tr>
            
            <td style="width:50%; ">Entreprise:</td>
            <td style="width:50%"><?php echo $empresa; ?></td>
			<td style="width:50%;text-align:right"> Teléphone société:</td>
			<td style="width:50%">&nbsp; <?php echo $tel2; ?> </td>
        </tr>
        <tr>
  ...
  <br/><br/>
    <table cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 10pt;padding:1mm;">
        <tr>
            ...
            <th style="width: 60%">PRODUIT / DESCRIPTION</th>
...
while ($row=mysqli_fetch_array($sql))
	...
	<table cellspacing="0" style="width: 100%; border: solid 1px black;  text-align: center; font-size: 11pt;padding:1mm;">
        <tr>
            ...
            <td style="width: 60%; text-align: center"><?php echo $nombre_producto/*.$marca_producto;*/?></td>
            <td style="width: 15%; text-align: center"><?php echo $precio_venta_f;?></td>
            <td style="width: 15%; text-align: center"><?php echo $precio_total_f;?></td>
